		...
		<form id="searchForm" class="form-horizontal" method="post">
		      ...
		      <form action="add" method="post" class="form-horizontal">
		        <div class="row">
		          <div class="control-group span9">
		            <label class="control-label">年度yyyy：</label>
		            <div class="controls">
		              <input name="year" type="text" data-rules="{required:true ,number:true}" class="input-normal control-text"/>
		            </div>
		          </div>
		        </div> 
		        ...
		        <div class="row">
		          <div class="span9 doc-content">
			 	 	<label class="control-label">初始销售额(万元)：</label>
			 	 		<div class="controls">
		        ...
		        <div class="row">
		          <div class="span9 doc-content">
			 	 	<label class="control-label">终止销售额(万元)：</label>
			 	 		<div class="controls">
		         ...
		         <div class="row">
		          <div class="span9 doc-content">
			 	 	<label class="control-label">业务提成(百分比)：</label>
			 	 		<div class="controls">
              			 <input name="ratio" type="text" data-rules="{required:true ,number:true}" class="input-normal control-text"/>
            			</div>
			 	 </div>       
		        </div>
		         <div class="row">
		    ...
		    <div id="detail" class="hide">
				<form action="detail" method="post" class="form-horizontal">
					...
					<div class="row">
						<div class="control-group span8">
							<label class="control-label">初始销售额：</label>
							<div class="controls">
					...
					<div class="row">
						<div class="control-group span9 ">
							<label class="control-label">终止销售额：</label>
							<div class="controls">
					...
					<div class="row">
						<div class="control-group span8">
							<label class="control-label">业务提成：</label>
							<div class="controls">
			...
			<script type="text/javascript">
		        ...
		        BUI.use(['bui/grid','bui/data','bui/form'],function(Grid,Data,Form){
		        		columns = [
		   						...
		   						{title:'年度',dataIndex:'year',width:'8%', elCls : 'left'},	   					
		   						{title:'起始额(万元)',dataIndex:'minsale',width:'10%',elCls : 'center'},
		   						{title:'终止额(万元)',dataIndex:'maxsale',width:'10%',elCls : 'center'},
		   						{title:'业务提成(%)',dataIndex:'ratio',width:'8%',elCls : 'center'},
		   						{title:'备注',dataIndex:'beizhu',width:'35%',renderer:Grid.Format.dateRenderer,elCls : 'center'},
		            ...
		            var store = new BUI.Data.Store({
		                ...
		                proxy : {
		                    save : { //也可以是一个字符串，那么增删改，都会往那么路径提交数据，同时附加参数saveType
		                        addUrl : 'businessteam/updateBusinessTeam',
		                        updateUrl : 'businessteam/updateBusinessTeam',		                       
		                      },
		                      method : 'POST',
		                    pageStart : 1
		                  },
		                url : 'businessteam/allBusinessTeam',
		                autoLoad:true,
			          ...
			          function delItems(items){
			            ...
			            if(ids != ""){
			              BUI.Message.Confirm('确认要删除选中的记录么？',function(){
			                $.ajax({
			                  url : 'businessteam/delBusinessTeam/'+ ids,
