		      ...
		      <form action="add" method="post" class="form-horizontal">
		        ...
		        <div class="row">
		          <div class="control-group span9">
		            ...
		            <div class="controls">
		              <input name="company" type="text" data-rules="{required:true}" class="input-normal control-text"/>
		            </div>
		          </div>
		        </div> 
		        <div class="row">
		          <div class="control-group span9">
		            <label class="control-label"><s>*</s>金额（万元）：</label>
		            <div class="controls">
		              <input name="salemoney" type="text" data-rules="{required:true ,number:true}" class="input-normal control-text"/>
		            </div>
		          </div>
		        </div> 
		        <div class="row">
		        ...
		        <div class="row">
		          <div class="control-group span9">
		            ...
		            <div class="controls">
		              <input name="beizhu" type="text" data-rules="{required:false}" class="input-normal control-text"/>
		            </div>
		          </div>
		        </div>       
		      </form>	      
				...
				<form action="detail" method="post" class="form-horizontal">
					 ...
					 <div class="row">
						<div class="control-group span9">
							<label class="control-label"><s>*</s>业务员：</label>
							<div class="controls">
							<input name="user_name" type="text" class="input-normal control-text" readonly="readonly"/>
							</div>
						</div>
					</div>
		          ...
		          <div class="control-group span8">
		            <label class="control-label"><s>*</s>公司：</label>
		            <div class="controls">
		            <input name="company" type="text" class="input-normal control-text" readonly="readonly"/>
		            </div>
		          </div>
		        </div>
		       <div class="row">
		          <div class="control-group span8">
		            <label class="control-label"><s>*</s>金额（万元）：</label>
		            <div class="controls">
		            <input name="salemoney" type="text" class="input-normal control-text" readonly="readonly"/>
		             </div>
		          </div>
		        </div>
		        <div class="row">
		         ...
		         <div class="row">
		          <div class="control-group span8">
		            ...
		            <div class="controls control-row4">
		              		<input name="beizhu" type="text" class="input-normal control-text" readonly="readonly"/>
		            </div>
		          </div>
		        </div>
				</form>
		            ...
		            var store = new BUI.Data.Store({
		                ...
		                proxy : {
		                    save : { //也可以是一个字符串，那么增删改，都会往那么路径提交数据，同时附加参数saveType
		                        addUrl : 'personal/updatePersonal',
		                        updateUrl : 'personal/updatePersonal',		                       
		                      },
		                      method : 'POST',
		                    pageStart : 1
		                  },
		                url : 'personal/allPersonal',
		                autoLoad:true,
